    ...
    <section className='bg-[#ffeeec] h-screen'>
      ...
      <section className='flex justify-between items-center h-[89vh]'>
        <div className=' w-[50%] flex flex-col mx-auto'>
          ...
          <div className='bg-white p-8 rounded-lg flex flex-col justify-center items-start w-[100%] my-7'>
            ...
            <div className='flex justify-between items-center my-2'>
              ...
              <button className='py-3 px-8 bg-[#F66754] rounded-lg text-white font-bold shadow-md'>Search</button>
            </div>
          </div>
        </div>
        <div className=''>
