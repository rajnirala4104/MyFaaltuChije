      ...
      <header className='h-[6rem] flex justify-evenly items-center'>
        ...
        <div className="menus flex items-center">
          <ul className='flex items-center'>
            ...
            <li className='flex items-center transit duration-200 justify-between bg-white rounded-lg py-2 px-3 text-[#F66754] cursor-pointer shadow-lg hover:shadow-md '>
              <span className='mx-1'>
                <UserIcon />
              </span>
              Signup Or Login
