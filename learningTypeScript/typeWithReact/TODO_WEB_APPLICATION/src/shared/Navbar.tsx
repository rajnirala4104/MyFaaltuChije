  ...
  return (
    <React.Fragment>
      <header className='bg-green-400 h-14 px-3 flex justify-between items-center'>
        <div className="logo">
          <span className='text-3xl text-green- font-bold'>
            TODO
          </span>
        </div>
      ...
      {navbarMenu ? (
        <div className='bg-green-100 transition px-4 py-3 flex justify-end items-center'>
          ...
          <span className='bg-green-300 ml-8 text-black p-2 rounded-md cursor-pointer hover:bg-green-400 transition duration-200'>Seaech</span>
        </div>
      ) : ""}
    </React.Fragment>
  )
